...
const HeroSection = () => {
  return (
    <section className="HeroSection page-section" id="1">
      <div className="HeroFlex">
        <div className="HeroContent">
          <div>
            <p>Hello,</p>
            <h1>
              I'm DurgaDevi <span>Shanmugam</span>
            </h1>
            <p>
              I am Full Stack Web Developer <br />
            </p>
            <div className="HeroSectionBtnFlex">
              <div>
                <a
                  href="mailto:durgadevishanmugam99@gmail.com?subject=Offering Letter for Job"
                  target="_newpage"
                >
              ...
              <div>
                <a href="./assets/resume/Resume.pdf" target="_blankpage">
        ...
        <div className="HeroImage">
          <div>
            <img src="./assets/hero-section/home-image.svg" alt="" />
          </div>
        </div>
      </div>
      <div className="HeroMailId">
        <a href="mailto:itsmrmaram001@gmail.com" target="_newpage">
      ...
      <div className="HeroSocialMedia">
        ...
        <div>
          <a href="https://github.com/Durgathev" target="_newpage">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
        ...
        <div>
          <a
            href="https://www.linkedin.com/in/durgadevi-shanmugam-1bab34252/"
            target="_newpage"
          >
            <svg
              width="18"
        ...
        <div>
          <a
            href="https://www.instagram.com/durgadevi_shanmugam?utm_source=qr&igsh=MWt1MzMydjdxanZqYg%3D%3D"
            target="_newpage"
          >
            <svg
              width="18"
